  ...
  return (
    <>
      ...
      <section className="text-center px-5 pt-12 pb-10 bg-gradient-to-b from-purple-light to-bg">
        <p className="text-xs font-semibold text-purple uppercase tracking-widest mb-3">
          India's cleanest government info site
        </p>
        <h1 className="heading text-3xl font-normal text-text leading-tight mb-3">
          Find Schemes You Qualify For
          <br />
          in 30 Seconds
        </h1>
        <p className="text-base text-text-secondary max-w-md mx-auto leading-relaxed mb-6">
          Answer 5 quick questions and get a personalized list of government
          schemes, benefits, and how to apply.
        </p>
        <Link
          href="/check-eligibility"
          className="inline-block px-8 py-3.5 rounded-xl bg-purple text-white text-base font-semibold shadow-lg shadow-purple/25 hover:shadow-purple/35 transition-shadow"
        >
      ...
      <div className="max-w-[800px] mx-auto px-5 pb-10">
        ...
        <div className="flex justify-between items-center mt-10 mb-4">
          ...
          <Link href="/exam" className="text-sm text-accent font-medium">
        ...
        <div className="flex justify-between items-center mt-10 mb-4">
          ...
          <Link href="/paisa" className="text-sm text-accent font-medium">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {articles.slice(0, 4).map((p) => (
            ...
            >
              ...
              <div className="text-sm font-semibold text-text mt-2.5 mb-1">
                {p.title}
              </div>
