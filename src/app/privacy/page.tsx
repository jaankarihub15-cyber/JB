  ...
  return (
    <div className="max-w-[860px] mx-auto px-6 py-10">
      ...
      <div className="text-text-secondary leading-relaxed space-y-4">
        ...
        <p className="text-base">JaankariHub respects your privacy. This policy explains what data we collect (very little) and how we use it.</p>
        ...
        <p className="text-base">Questions about this policy? Email us at hello@jaankarihub.in</p>
      </div>
    </div>
  );
}
