...
export const metadata: Metadata = {
  ...
  description: "KnowledgeKendra is built by Ash K. to help young Indians navigate government schemes, competitive exams, and personal finance. Learn about our editorial standards.",
};
    ...
    <div className="max-w-[860px] mx-auto px-6 py-10">
      ...
      <div className="prose max-w-none text-text-secondary leading-relaxed space-y-6">
        ...
        <section id="methodology">
          <h2 className="heading text-xl mt-8 mb-3 text-text">Our Editorial Process</h2>
          <p className="text-base">Every article on KnowledgeKendra goes through a structured verification process before publishing:</p>
          <div className="mt-4 space-y-3">
            ...
            <div className="flex gap-3 items-start">
              ...
              <p className="text-base"><strong>Cross-Verification</strong> — Key data points (benefit amounts, age limits, income thresholds) are cross-checked against at least two official sources before publishing. When sources conflict, we use the most recent official notification.</p>
            </div>
            <div className="flex gap-3 items-start">
              <span className="text-accent font-bold text-lg mt-0.5">3.</span>
              <p className="text-base"><strong>Regular Updates</strong> — Every article carries a "Last Reviewed" date. Pages are reviewed and updated when government notifications change eligibility criteria, benefit amounts, or application processes.</p>
            </div>
            <div className="flex gap-3 items-start">
              <span className="text-accent font-bold text-lg mt-0.5">4.</span>
              <p className="text-base"><strong>Source Transparency</strong> — Official source links are provided on every page so readers can verify information independently. We never publish information we cannot trace back to an official document.</p>
            </div>
          </div>
        </section>
