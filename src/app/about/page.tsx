...
export const metadata: Metadata = { title: "About JaankariHub" };
export default function AboutPage() {
  return (
    <div className="max-w-[860px] mx-auto px-6 py-10">
      <h1 className="heading text-3xl mb-6">About JaankariHub</h1>
      <div className="prose max-w-none text-text-secondary leading-relaxed space-y-4">
        <p className="text-base">JaankariHub is a free information platform that makes government schemes, competitive exams, and personal finance easy to understand for everyone in India.</p>
