...
export default function NewsPage() {
  ...
  return (
    <div className="max-w-[860px] mx-auto px-5 py-6">
      ...
      <p className="text-base text-text-secondary leading-[1.75] mb-6">Latest government scheme announcements, exam notifications, recruitment updates, and policy changes.</p>
