  ...
  return (
    <div className="max-w-[1000px] mx-auto px-6 py-10">
      ...
      <div className="text-text-secondary leading-relaxed space-y-4">
        <p className="text-base">The information provided on KnowledgeKendra is for general informational and educational purposes only. While we strive to keep the content accurate and up-to-date, we make no guarantees about the completeness, reliability, or accuracy of any information on this site.</p>
        <h2 className="heading text-xl mt-6 mb-3 text-text">Not Official Government Source</h2>
        <p className="text-base">KnowledgeKendra is not affiliated with, endorsed by, or connected to any government department or agency. All government scheme information is sourced from official portals and public documents, but for the most current and authoritative information, always refer to the official government websites linked on each page.</p>
