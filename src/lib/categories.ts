...
export const states: Record<StateKey, {
  ...
  "jharkhand": { slug: "jharkhand", label: "Jharkhand", short: "JH" },
  "himachal-pradesh": { slug: "himachal-pradesh", label: "Himachal Pradesh", short: "HP" },
  ...
  "west-bengal": { slug: "west-bengal", label: "West Bengal", short: "WB" },
  "gujarat": { slug: "gujarat", label: "Gujarat", short: "GJ" },
  "punjab": { slug: "punjab", label: "Punjab", short: "PB" },
  "tamil-nadu": { slug: "tamil-nadu", label: "Tamil Nadu", short: "TN" },
  "kerala": { slug: "kerala", label: "Kerala", short: "KL" },
};
