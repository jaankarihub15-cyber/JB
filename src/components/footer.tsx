      ...
      <div className="max-w-[1100px] mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/fix" className="text-xs text-text-secondary hover:text-accent transition-colors">Fix Document Errors</Link>
              ...
              <Link href="/legal" className="text-xs text-text-secondary hover:text-accent transition-colors">Legal Guides</Link>
              <Link href="/news" className="text-xs text-text-secondary hover:text-accent transition-colors">News</Link>
        ...
        <div className="border-t border-border pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-text-muted text-center">
            © 2026 KnowledgeKendra by Ash K. · All info sourced from official government portals
          </p>
        </div>
      </div>
    </footer>
